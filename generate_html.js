...
"");
    ...
    pages.set('quick_and_dirty', ' <div class="maincol">' +
...
"");
    pages.set('classics', '<div class="maincol">' +
        '		<h2>Classic funny moments in ##programming on freenode</h2>' +
        '		<BR><h3>TempleOS</h3>' +
...
"");
    ...
    for (var q of by_id.keys()) {
        ...
        fs.writeFileSync(q + ".html", html_prefix + text + html_suffix);
    }
	/*
